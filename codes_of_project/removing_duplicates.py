...
INPUT_FILE = os.path.join(INPUT_DIR, "merged.csv")
OUTPUT_FILE = os.path.join(INPUT_DIR, "merged_deduped.csv")
CHUNK_SIZE = 300_000
...
with open(OUTPUT_FILE, "w", newline="", encoding="utf-8") as out:
    for chunk in pd.read_csv(INPUT_FILE, chunksize=CHUNK_SIZE, low_memory=False):
        ...
        # hash each row (as tuple) to check duplicates across chunks
